class OS:
    ...
    @classmethod
    def total_installations(cls: OS) -> None:
        print(f"{cls.times_installed} OS installed so far!")


operating_system = OS("pythonOS", "1.0", "5.10.0-19-amd64", 16)
operating_system.filesystem = ["/home", "/downloads", "/documents"]
operating_system.times_installed
print(total_installations.times_installed())
